	                	...
	                	<div class="customer_items">
	                        ...
	                        <div class="customer_items_right">
	                            ...
	                            <div class="customer_items_right_items">
                                    ...
                                    <h3 style="font-size:12px">Facebook    :   <a href="<?php echo $items['student_face'] != null ? $items['student_face'] : 'javascript:void(0)'; ?>" target="_blank" title="Chat với <?php echo $items['student_name']; ?>" style="font-size:11px;color:#900">Xem</a></h3>
	                            </div>
	                        </div>
	                        <div class="cls"></div>
	                    </div>
