					...
					<div class="title_wrapper">
						...
						<div class="title_wrapper_inner">
							...
							<div class="title_wrapper_content">
								<h2 class="menu_title">Danh sách Slideshow</h2>
							</div>
						</div>
					...
					<div class="section_content">
						...
						<div class="section_content_inner minheight">
                            ...
                            <ul class="table_tabs">
								...
								<li><a href="<?php echo base_url(); ?>admin/slideshow/add" name=""><span><span>Thêm mới</span></span></a></li>
							</ul>
                            ...
                            <form action="" method="post" name="sac">
								<table cellpadding="0" cellspacing="0" width="905">
									<tbody><tr>
										<th width="26">Stt.</th>
									  <th width="178"><a href="#">Ảnh</a></th>
									  <th width="190"><a href="#">Tiêu đề ảnh</a></th>
									  <th width="298"><a href="#">Link ảnh</a></th>
									...
									if(isset($info) && $info != NULL){
										...
										foreach($info as $items){
											...
											echo "<tr class='first'>";
											echo "<td>$stt</td>";
											echo "<td><img src='".base_url().$items['slide_link']."' /></td>";
											echo "<td>".$items['slide_title']."</td>";
											echo "<td>".$items['slide_link']."</td>";
											if($items['slide_status'] == 1){
												 echo "<td><a href='".base_url()."admin/slideshow/active/$items[slide_id]/0'>Active</a></td>";
											}else{
												echo "<td><a href='".base_url()."admin/slideshow/active/$items[slide_id]/1'>Not active</a></td>";									}
											echo "<td>";
												echo "<div class='actions_menu'><ul>";
													echo "<li><a href='".base_url()."admin/slideshow/update/$items[slide_id]/' class='edit'>Edit/a></li>";
													echo "<li><a href='".base_url()."admin/slideshow/del/$items[slide_id]/' class='delete' onclck='return check()'>Del</a></li>";
												echo "</ul></div>";
											echo "</td>";
											echo "</tr>";
										}
