				...
				<!--[if !IE]>start table_wrapper<![endif]-->
							<div class="table_wrapper" style="background:none;">
								<div class="table_wrapper_inner">
									...
									<form action="<?php echo base_url();?>admin/posts/add" method="post" name="sac" onsubmit="return checkForm()" enctype="multipart/form-data">
									...
									<div class="form_items">
                                        ...
                                        <div class="form_items_right">
                                        <textarea name="post_keys" cols="45" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="form_items">
                                    	<div class="form_items_left">Description</div>
                                        <div class="form_items_right">
                                        <textarea name="post_des" cols="45" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="form_items">
