                ...
                <script type="text/javascript">
					$(document).ready(function(e) {
                        $("#ok").click(function(){
							...
							$show = $("#user_show");
							$.ajax({
								"url"   : "<?php echo base_url();?>admin/posts/search",
								"type"  : "post",
								"data"  : "val="+$val,
								"acsync": false,
					...
					<div class="title_wrapper">
						...
						<div class="title_wrapper_inner">
							...
							<div class="title_wrapper_content">
								<h2 class="menu_title">Quản lý bài viết</h2>
							</div>
						</div>
					...
					<div class="section_content">
						...
						<div class="section_content_inner minheight">
                            ...
                            <ul class="table_tabs">
								...
								<li><a href="<?php echo base_url(); ?>admin/posts/add" name=""><span><span>Thêm mới</span></span></a></li>
							</ul>
								...
								<?php
										echo "<td>";
												echo "<div class='actions_menu'><ul>";
													...
													echo "<li><a href='".base_url()."admin/posts/del/".$item['post_id']."' class='delete' onclick='return check()'>Del</a></li>";
												echo "</ul></div>";
											echo "</td>";
