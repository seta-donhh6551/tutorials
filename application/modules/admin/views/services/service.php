				...
				<!--[if !IE]>start table_wrapper<![endif]-->
							<div class="table_wrapper" style="background:none;">
								<div class="table_wrapper_inner">
									...
									<form action="<?php echo base_url()."admin/services/update/".$getdata['service_id'];?>" method="post" name="sac" onsubmit="return checkuser()" enctype="multipart/form-data">
                                    <div class="form_items">
                                    	<div class="form_items_left">Mô tả</div>
                                        <div class="form_items_right">
                                        <?php 
										$fck = new FCKeditor('service_info');
										$fck->BasePath = sBASEPATH;
										$fck->Value  = $getdata['service_info'];
										$fck->Width  = '100%';
										$fck->Height = 400;
										$fck->Create();
										?>
                            		...
                            		<div class="form_items">
                                        ...
                                        <div class="form_items_right">
                                        <?php 
										$fck = new FCKeditor('service_full');
										$fck->BasePath = sBASEPATH;
										$fck->Value  = $getdata['service_full'];
										$fck->Width  = '100%';
										$fck->Height = 400;
										$fck->Create();
										?>
