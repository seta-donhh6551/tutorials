				...
				<!--[if !IE]>start table_wrapper<![endif]-->
							<div class="table_wrapper" style="background:none;">
								<div class="table_wrapper_inner">
                                    ...
                                    <form action="<?php echo base_url()?>admin/education/add" method="post" name="sac" onsubmit="return check()" enctype="multipart/form-data">
                                    	 <div class="form_items">
                                    		<div class="form_items_left">Tiêu đề môn học</div>
                                        	<div class="form_items_right"><input type="text" name="education_title" size="35" /></div>
                                   		 </div>
                                         <div class="form_items">
                                    		<div class="form_items_left">Thứ tự</div>
                                        	<div class="form_items_right"><input name="education_order" type="text" size="35"></div>
                                   		 </div>
                                         <div class="form_items">
                                    		<div class="form_items_left">Hình ảnh</div>
                                        	<div class="form_items_right"><input name="image" type="file" id="img" size="35" /></div>
                                   		 </div>
                                         <div class="form_items">
                                         ...
                                         <div class="form_items">
                                        	...
                                        	<div class="form_items_right"><input type="submit" name="ok" value="Add now" class="magin"/></div>
                                   		 </div>
                                    </form>
								</div>
							</div>
