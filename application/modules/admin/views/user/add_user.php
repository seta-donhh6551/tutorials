				...
				<!--[if !IE]>start table_wrapper<![endif]-->
							<div class="table_wrapper" style="background:none;">
								<div class="table_wrapper_inner">
									...
									<form action="<?php echo base_url();?>admin/user/add" method="post" name="sac" onsubmit="return checkuser()" enctype="multipart/form-data">
                                    ...
                                    <div class="form_items">
                                        ...
                                        <div class="form_items_right"><input type="text" name="name" size="30"  /></div>
                                    </div>
                                    <div class="form_items">
                                    ...
                                    <div class="form_items">
                                        ...
                                        <div class="form_items_right"><input type="text" name="adress" size="30"  /></div>
                                    </div>
                                    <div class="form_items">
