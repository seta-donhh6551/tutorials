				...
				<div class="table_wrapper_inner">
					...
					<form action="<?php echo base_url()?>admin/cate/add" method="post" name="sac" onsubmit="return check()" enctype="multipart/form-data">
						 ...
						 <div class="form_items">
							...
							<div class="form_items_right"><input name="cate_title_seo" type="text" size="35"></div>
						 </div>
						 <div class="form_items">
						 ...
						 <div class="form_items">
							...
							<div class="form_items_right"><textarea name="cate_keys" cols="35" rows="5"></textarea></div>
						 </div>
						 <div class="form_items">
