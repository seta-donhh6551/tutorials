			...
			<div class="table_wrapper" style="background:none;">
				<div class="table_wrapper_inner">
					...
					<form action="<?php echo base_url()?>admin/cate/updatemn/<?php echo $list['cate_id']?>" method="post" name="sac" onsubmit="return check()" enctype="multipart/form-data">
						 ...
						 <div class="form_items">
							<div class="form_items_left">Tiêu đề Seo</div>
							<div class="form_items_right"><input name="cate_title_seo" type="text" value="<?php echo $list['cate_title_seo']; ?>" size="35"></div>
						 </div>
						 <div class="form_items">
						 ...
						 <div class="form_items">
							...
							<div class="form_items_right"><textarea name="cate_keys" cols="35" rows="5"><?php echo $list['cate_keys']; ?></textarea></div>
						 </div>
						 <div class="form_items">
