					...
					<div class="section_content">
						...
						<div class="section_content_inner minheight">
                            ...
                            <ul class="table_tabs">
								...
								<li><a href="<?php echo base_url(); ?>admin/support/add" name=""><span><span>Thêm mới</span></span></a></li>
							</ul>
								...
								<table cellpadding="0" cellspacing="0" width="905">
                                    ...
                                    <tr>
										<th width="24"><input type="checkbox" name="checkall" onclick="chkallClick(this)"/></th>
									  	<th width="167"><a href="#">Tên hiển thị</a></th>
									  	<th width="152"><a href="#">Nick yahoo</a></th>
									  	<th width="145"><a href="#">Phone number</a></th>
									  	<th width="144"><a href="#">Nick skype</a></th>
									  	<th width="199"><a href="#">Email</a></th>
										...
										foreach($info as $items){
												...
												echo "<td>";
													echo "<div class='actions_menu'><ul>";
														echo "<li><a href='".base_url()."admin/support/update/".$items['sup_id']."' class='edit'>Edit</a></li>";
														echo "<li><a href='".base_url()."admin/support/del/".$items['sup_id']."' class='delete' onclick='return check()'>Del</a></li>";
													echo "</ul></div>";
												echo "</td>";
												echo "</tr>";
										}
