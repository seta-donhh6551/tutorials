					...
					<div class="section_content">
						...
						<div class="section_content_inner minheight">
                            ...
                            <ul class="table_tabs">
								...
								<li><a href="<?php echo base_url(); ?>admin/articles/add" name=""><span><span>Thêm mới</span></span></a></li>
							</ul>
                            ...
                            <form action="" method="post" name="sac">
								<table cellpadding="0" cellspacing="0" width="905">
									<tbody><tr>
									  <th width="30"><input type="checkbox" name="checkall" onclick="chkallClick(this)"/></th>
									  <th width="448"><a href="#">Tiêu đề</a></th>
									  <th width="138"><a href="#">Thứ tự hiển thị</a></th>
                                      <th width="194"><a href="#">Ngày</a></th>
                               ...
                               <?php
								if(isset($info) && $info != NULL){
									foreach($info as $item){
										echo "<tr>";	
										echo "<td><input type='checkbox' name='check[]' value='".$item['article_id']."'/></td>";
										echo "<td>".$item['article_title']."</td>";
										echo "<td>".$item['article_order']."</td>";
										echo "<td>".$item['article_date']."</td>";
										echo "<td>";
												echo "<div class='actions_menu'><ul>";
													echo "<li><a href='".base_url()."admin/articles/update/".$item['article_id']."' class='edit'>Edit</a></li>";
