                ...
                <script type="text/javascript">
					$(document).ready(function(e) {
                        $("#ok").click(function(){
							...
							$show = $("#user_show");
							$.ajax({
								"url"   : "<?php echo base_url();?>admin/subjects/search",
								"type"  : "post",
								"data"  : "val="+$val,
								"acsync": false,
					...
					<div class="section_content">
						...
						<div class="section_content_inner minheight">
                            ...
                            <ul class="table_tabs">
								...
								<li><a href="<?php echo base_url(); ?>admin/subjects/add" name=""><span><span>Thêm mới</span></span></a></li>
							</ul>
                            ...
                            <form action="" method="post" name="sac">
								<table cellpadding="0" cellspacing="0" width="905">
									<tbody><tr>
									  <th width="23">Stt.</th>
									  <th width="300"><a href="#">Tên khoá</a></th>
									  <th width="136"><a href="#">Số thứ tự</a></th>
									  <th width="132"><a href="#">Trạng thái</a></th>
                               ...
                               <?php
								...
								if(isset($info) && $info != NULL){
									foreach($info as $items){
										...
										echo "<tr>";	
										echo "<td>$stt</td>";
										echo "<td>".$items['subject_title']."</td>";
										echo "<td>".$items['subject_order']."</td>";
										if($items['subject_status'] == 1){
											echo "<td>Active</td>";
										}else{
										...
										echo "<td>";
												echo "<div class='actions_menu'><ul>";
													echo "<li><a href='".base_url()."admin/subjects/update/$items[subject_id]/' class='edit'>Edit</a></li>";
													echo "<li><a href='javascript:void(0)' class='delete' onclick='return check()'>Del</a></li>";
													//echo "<li><a href='".base_url()."admin/subjects/del/$items[subject_id]/' class='delete' onclick='return check()'>Del</a></li>";
												echo "</ul></div>";
											echo "</td>";
