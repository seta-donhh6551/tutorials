                ...
                <script type="text/javascript">
					$(document).ready(function(e) {
                        $("#ok").click(function(){
							...
							$show = $("#user_show");
							$.ajax({
								"url"   : "<?php echo base_url();?>admin/students/search",
								"type"  : "post",
								"data"  : "val="+$val,
								"acsync": false,
					...
					<div class="section_content">
						...
						<div class="section_content_inner minheight">
                            ...
                            <ul class="table_tabs">
								...
								<li><a href="<?php echo base_url(); ?>admin/students/add" name=""><span><span>Thêm mới</span></span></a></li>
							</ul>
                            ...
                            <form action="" method="post" name="sac">
								<table cellpadding="0" cellspacing="0" width="905">
									<tbody><tr>
										<th width="26">Stt.</th>
									  <th width="244"><a href="#">Họ tên</a></th>
									  <th width="203"><a href="#">Số điện thoại</a></th>
									  <th width="219"><a href="#">Email</a></th>
									...
									if(isset($info) && $info != NULL){
										...
										foreach($info as $items){
											...
											echo "<tr class='first'>";
											echo "<td>$stt</td>";
											echo "<td>".$items['student_name']."</td>";
											echo "<td>".$items['student_phone']."</td>";
											echo "<td>".$items['student_email']."</td>";
											if($items['student_status'] == 1){
												echo "<td>Active</td>";
											}else{
											...
											echo "<td>";
												echo "<div class='actions_menu'><ul>";
													echo "<li><a href='".base_url()."admin/students/update/$items[student_id]' class='edit'>Edit</a></li>";
													echo "<li><a href='".base_url()."admin/students/del/$items[student_id]' class='delete' onclick='return check()'>Del</a></li>";
												echo "</ul></div>";
											echo "</td>";
											echo "</tr>";
										}
