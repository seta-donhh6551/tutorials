    ...
    function inner($posts, $td_column_number = '') {
        ...
        if (!empty($posts[0])) {
            ...
            <script type="text/template" id="<?php echo $this->block_uid . '_tmpl' ?>">
                <article id="post-<?php echo $td_mod_single->post->ID; ?>"
                         class="<?php echo join(' ', get_post_class('td-post-template-6')); ?>" <?php echo $td_mod_single->get_item_scope(); ?>>
	        ...
	        <script>
		        (function() {
			        ...
			        jQuery('body').prepend(jQuery('#<?php echo $this->block_uid ?>_tmpl').html());
			        ...
			        // add to body
			        jQuery('body').prepend(td_homepage_full_bg_image_wrapper1);
